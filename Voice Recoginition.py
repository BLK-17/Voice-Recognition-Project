...
recognizer = sr.Recognizer()  # Initialize recognizer here

# Define specific paths
DESKTOP_PATH = r"C:\Users\banig\OneDrive\Desktop"
DOCUMENTS_PATH = r"C:\Users\banig\OneDrive\Documents"
...
def listen():
    with sr.Microphone() as source:
        print("Listening...")
        recognizer.adjust_for_ambient_noise(source)  # Adjust once here
...
def open_website(command):
    ...
    if "youtube" in command:
        ...
        speak("Opening Gmail")
        os.startfile("https://www.gmail.com")
...
def handle_command(command):
    if "hello" in command:
        ...
        if any(folder in command for folder in ["desktop", "downloads", "documents"]):
